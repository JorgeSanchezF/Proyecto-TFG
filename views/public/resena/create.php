...
<body>
    <div class="container mt-5">
        <a class="btn btn-secondary" href="estadisticas">Volver</a>
        <h2>Escribe tu reseña</h2>
        <form action="resena-save" method="POST" id="puntuacion-form" class="needs-validation" novalidate>
            <div class="form-group">
                <input type="hidden" class="form-control" id="juego_id" name="juego_id"
                    value="<?php echo $juego_id = $_GET['juego_id'] ?>">
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control" id="texto" name="texto" maxlength="999" rows="4" required></textarea>
            ...
            <div class="form-group">
                ...
                <input type="number" class="form-control" id="duracion" name="duracion" min="0" step="1" required>
